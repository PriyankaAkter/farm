...
const ContactForm = () => {
  return (
    <div className="w-full 2xl:w-[1184px] 2xl:mx-auto px-4">
      <form action="/" className="grid gap-12">
        ...
        <textarea name="" id="" cols="30" rows="10" placeholder="hello there,i would like to talk about how to..." className="w-full border border-secondary pt-7 pl-6 rounded-2xl"></textarea>
        <button className="py-7 px-11 text-xl text-white bg-primary rounded-2xl w-fit">Send Message</button>
      </form>
    </div>
  );
};
